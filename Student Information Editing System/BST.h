...
struct BST {
		...
		//function b,c,d,e,f
		bool findDuplicateID(int);
		bool findDuplicateID2(int, BTNode*);

		bool deepestNodes();
		void printDeepestNodes(BTNode*, int, int);

		bool display(int, int);
		void display1(BTNode*, int);
		void display2(BTNode*, int);
		...
		void printGivenLevel(BTNode*, int);

		bool printPath();
		void printPathsUtil(BTNode*, string);
